...
| 3 | Fixed `τ = (1, 7, 28, 84)` | Free `τ_i` per dimension (or a finer fixed schedule with extended train window) | Are the time constants identifiable from data? Are they near `(1, 7, 28, 84)`? |
